...
**Nutzungsprofil — die härteste Randbedingung dieses Produkts:** ~5–10 Personen, die das
Werkzeug **nicht selbst ausgesucht haben**, nutzen es in **Schüben von ~2–3 Wochen**,
danach monatelang nicht. Das hat drei Konsequenzen, die durch das ganze Dokument tragen:
...
Menschen in ein System zu schreiben, das sie nicht ausgesucht haben. Die
...
| **S-03** **Ein** Beitrittscode/-Link für den ganzen Haushalt; Ein-Schritt-Registrierung; Passwort primär und universell; Passkey als optionaler, abschaltbarer Aufsatz; E-Mail-Verifikation nachgelagert und nicht abstimmungsblockierend | Einladung pro Person, Magic-Link-Login (verworfen: nicht gerätegebunden), SMS-Verifikation |
...
| **S-28** `Notification`: In-App und E-Mail, **Digest als Standard**, Ereignisauswahl in `HouseholdSettings` **und** persönlichen Einstellungen; Inhalte unterliegen derselben Sichtbarkeitspolicy | Web Push (v1.1), Verifikationsfreier Mailversand, Benachrichtigung an Bewerbende |
...
|-------|--------|------|--------------|
| **v1** | S-01 bis S-40 sowie das **Datenmodell** von S-41: Haushalts- und Bewohner-Onboarding · `CastingRound` mit `Room`s · Bewerbererfassung (Formular + regelbasierter Paste-Parser, mit Art.-13/14-Weiche und Absatzverwerfung) · Zuordnung früherer Bewerbungen · Card-Screening · Abstimmung R1 mit Feinschliff · Rangliste + Quorum · Status-Pipeline komplett · Verfügbarkeits-Raster + Feasibility + Solver-Knopf · `CastingNote`s · Abstimmung R2 + `Veto` · Kalenderansicht · `ActivityEvent`-Feed · In-App-/E-Mail-`Notification` · PWA · Aufbewahrungsautomatik mit Vorwarnung · Datenauskunft-Export | **„Ein echter Haushalt führt eine vollständige Runde von der ersten `Application` bis `moved_in` durch, ohne nach WhatsApp auszuweichen."** Die Beteiligungsquote wird hier zum ersten Mal messbar | — |
| **v1.1** | **Bewerberseitige Token-Seite** für Verfügbarkeiten (Zeitraster, kein Konto — Datenmodell liegt bereits in v1, S-17, O-08) · **Oberfläche für `subject_statement`** (S-41) · Web Push mit dokumentiertem iOS-Vorbehalt · Punkte-Budget-Variante als wählbare Option · Textbausteine für die Kontaktaufnahme | „Der Komfort kommt nach, ohne dass v1 davon abhängig war." Jedes v1.1-Feature ist bewusst eine **Bequemlichkeit über einem vollständigen manuellen Pfad** (P-1) | v1 |
...
| Punkt | Festlegung |
|-------|------------|
| **Wer** | (1) **Die Bewohnenden des ersten realen Haushalts** — die einzige belastbare Quelle, weil sie das Werkzeug nicht ausgesucht haben. (2) **Bewerbende**, die eine Absage erhalten haben — die Gruppe mit dem geringsten Einfluss und dem größten Interesse; ihre Sicht ist nur über die WG erreichbar. (3) Fachliche Gegenlesung der Compliance- und Architekturentscheidungen. (4) Später: weitere Haushalte |
...
| Wie viele Werkzeuge waren beteiligt? | Zählung | Ziel: Reduktion auf eines plus Anzeigenportal |
...
| **O-05** | Spendenkommunikation und ihre Platzierung | Non-Profit-Modell (E-23) ohne festgelegten Ort im Produkt | Nach der ersten realen Runde. Nicht vor dem Launch spezifizieren |
