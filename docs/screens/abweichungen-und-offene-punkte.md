...
| ~~O-B~~ | ~~Standardwerte Einladungslink~~ | Ablauf 7 Tage · Nutzungsgrenze = fehlende Bewohnende, beides in `HouseholdSettings` änderbar | **Geklärt (damaliger Stand):** `04-Domaenenmodell.md` §10.2 (O-15) — Ablauf 7 Tage, Nutzungsgrenze = fehlende Bewohnende. **Nutzungsgrenze seit 2026-09-16 aktualisiert** auf Standard 1 (Einmal-Code) mit Gründungs-Link-Ausnahme — aktueller Wert: `domain/offene-punkte.md` (O-15) |
