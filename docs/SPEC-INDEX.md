...
| **Einladungslink** (`JoinCodeIssuance`) | **`02-SRD.md` §5.3** bei **S-49** — Ablauf, Nutzungsgrenze, Warnhinweis. **Zahl, Lebenszyklus und Historie der Links: `domain/identity.md` §2.1** (O-18, aufgelöst 2026-09-21); **Cardinalität** als Anforderung in `F2-requirements.md` **FR-2.1** | `domain/identity.md` · `04-Domaenenmodell.md` §10.2 (O-15) · `08-UX-Entscheidungen.md` U-12 · `F2-requirements.md` |
...
| **Zweistufiges Entfernen** (weich `moved_out`, reversibel — hart `removed`, endgültig, DB-erzwungen) | **`08-UX-Entscheidungen.md` U-27** | `domain/identity.md` §2.1 · `domain/invarianten.md` §5.3 (V-3) · `screens/O-organisation.md` (O16) · `F1-requirements.md` FR-1.4, FR-1.25, FR-1.26, FR-1.30, FR-1.31 · `review-log.md` §Offene-Punkte-Register (Menschliche Entscheidung, 2026-09-22) |
